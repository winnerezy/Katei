...
import { CalendarCog, LucideLayoutDashboard, Notebook, PencilIcon, XIcon } from "lucide-react"
...
export const SideBar = () => {
  ...
  return (
    <aside className={cn("w-[250px] min-h-screen bg-[--bg3] flex flex-col gap-12 items-center py-20 max-md:absolute max-md:top-0 max-md:left-0 transition duration-200 z-50 px-8", isOpen ? "max-md:translate-x-0 w-full" : "max-md:-translate-x-full")}>
       <XIcon 
